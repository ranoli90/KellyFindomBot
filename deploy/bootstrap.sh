...
echo ""
echo "  python heather_telegram_bot.py --personality kelly_persona.yaml --small-model"
echo ""
warn "Enter your phone number and verification code when prompted."
warn "This creates heather_session.session — upload it to S3:"
echo ""
echo "  aws s3 cp heather_session.session s3://${PROJECT}-media-${ACCOUNT_ID}/session/heather_session.session"
echo ""
